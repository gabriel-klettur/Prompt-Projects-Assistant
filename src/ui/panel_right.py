...
class RightPanel:
    def __init__(self, parent, controller):
        ...
        # Área de texto para el prompt final
        ...
        self.btn_copiar = ctk.CTkButton(botones_frame, text=i18n.t("copy"),
                                        command=self.controller.copiar_prompt, width=150)
        self.btn_copiar.pack(side="left", padx=10)
        self.btn_limpiar = ctk.CTkButton(botones_frame, text=i18n.t("clear"),
                                        command=self.controller.limpiar_todo, width=150)
